...
import com.example.library2.security.MySimpleUrlAuthenticationSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
        .rememberMe().userDetailsService(this.userDetailService).tokenValiditySeconds(86400);
